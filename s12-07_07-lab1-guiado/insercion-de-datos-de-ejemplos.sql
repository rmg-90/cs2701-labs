--- Inserción de ejemplos de datos

---- Tabla candidato

INSERT INTO candidato VALUES
('Acción Popular','Yonhy Lescano',0),
('Alianza para el Progreso','César Acuña',0),
('Avanza País','Hernando De Soto',0),
('Contigo','Máximo San Román',0),
('Democracia Directa','Andrés Avelino Alcantara',0),
('Frente Amplio','Marco Arana',0),
('Frente de la Esperanza 2021','Fernando Olivera',0),
('Fuerza Popular','Keiko Fujimori',0),
('Juntos por el Perú','Verónika Mendoza',0),
('Partido Aprista Peruano','Nidia Vílchez',0),
('Partido Morado','Julio Guzmán',0),
('Partido Nacionalista Peruano','Ollanta Humala',0),
('Partido Popular Cristiano','Alberto Beingolea',0),
('Perú Libre','Pedro Castillo',0),
('Perú Nación','Francisco Diez Canseco',0),
('Perú Patria Segura','Rafael Santos',0),
('Podemos Perú','Daniel Urresti',0),
('Renovación Popular','Rafael López Aliaga',0),
('RUNA','Ciro Gálvez',0),
('Restauración Nacional','George Forsyth',0),
('Somos Perú','Daniel Salaverry',0),
('Todos por el Perú','Fernando Cillóniz',0),
('Unión por el Perú','José Vega',0);
